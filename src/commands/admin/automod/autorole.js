...
const Premium = require("../../../models/premiumModel"); // ייבוא המודל פרימיום
...
module.exports = {
    ...
    async messageRun(message, args, data) {
        // בדוק אם יש לשרת פרימיום
      /*  console.log(`Checking premium for guild: ${message.guild.id}`);
        ...
        if (!premiumData || !premiumData.isPremium) {
            return message.safeReply("This server does not have premium enabled."); // לא מאפשר להמשיך
        }*/
    ...
    async interactionRun(interaction, data) {
        // בדוק אם יש לשרת פרימיום
       /* const premiumData = await Premium.findOne({ guildId: interaction.guild.id });
        console.log(premiumData);

        if (!premiumData || !premiumData.isPremium) {
            return interaction.followUp("This server does not have premium enabled."); // לא מאפשר להמשיך
        }*/
